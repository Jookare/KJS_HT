...
// Two arguments so we check if the second argument equals zero (keyword for resetting counter)
  ...
  1c:	75 49                	jne    67 <main+0x67>
		int arg = myAtoi(argv[1]);
  1e:	8b 5a 04             	mov    0x4(%edx),%ebx
	for (int i = 0; str[i] != '\0'; i++){
  21:	0f be 03             	movsbl (%ebx),%eax
  24:	84 c0                	test   %al,%al
  26:	74 55                	je     7d <main+0x7d>
  28:	8d 4b 01             	lea    0x1(%ebx),%ecx
	int result = 0;
  2b:	31 d2                	xor    %edx,%edx
  2d:	8d 76 00             	lea    0x0(%esi),%esi
		result = result * 10 + str[i] - '0';
  30:	8d 14 92             	lea    (%edx,%edx,4),%edx
  33:	83 c1 01             	add    $0x1,%ecx
  36:	8d 54 50 d0          	lea    -0x30(%eax,%edx,2),%edx
	for (int i = 0; str[i] != '\0'; i++){
  3a:	0f be 41 ff          	movsbl -0x1(%ecx),%eax
  3e:	84 c0                	test   %al,%al
  40:	75 ee                	jne    30 <main+0x30>
		if (arg == 0){
  42:	85 d2                	test   %edx,%edx
  44:	74 37                	je     7d <main+0x7d>
			resetreadcount();
...
// If more than 2 arguments then we print this error message.
  ...
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 53 08 00 00       	push   $0x853
  6e:	6a 01                	push   $0x1
  70:	e8 2b 04 00 00       	call   4a0 <printf>
  75:	83 c4 10             	add    $0x10,%esp
	}
	exit();
  78:	e8 c5 02 00 00       	call   342 <exit>
			resetreadcount();
  7d:	e8 68 03 00 00       	call   3ea <resetreadcount>
			printf(1, "readcount reset\n");
  82:	50                   	push   %eax
  83:	50                   	push   %eax
  84:	68 12 08 00 00       	push   $0x812
  89:	6a 01                	push   $0x1
  8b:	e8 10 04 00 00       	call   4a0 <printf>
  90:	83 c4 10             	add    $0x10,%esp
  93:	eb e3                	jmp    78 <main+0x78>
		printf(1, "Number of read calls: %d\n", getreadcount());
  95:	e8 48 03 00 00       	call   3e2 <getreadcount>
  9a:	52                   	push   %edx
  9b:	50                   	push   %eax
  9c:	68 f8 07 00 00       	push   $0x7f8
  a1:	6a 01                	push   $0x1
  a3:	e8 f8 03 00 00       	call   4a0 <printf>
  a8:	83 c4 10             	add    $0x10,%esp
  ab:	eb cb                	jmp    78 <main+0x78>
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
...
int myAtoi(char* str){
  ...
  b3:	8b 4d 08             	mov    0x8(%ebp),%ecx
	for (int i = 0; str[i] != '\0'; i++){
  b6:	0f be 11             	movsbl (%ecx),%edx
  b9:	84 d2                	test   %dl,%dl
  bb:	74 23                	je     e0 <myAtoi+0x30>
  bd:	83 c1 01             	add    $0x1,%ecx
	int result = 0;
  c0:	31 c0                	xor    %eax,%eax
  c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		result = result * 10 + str[i] - '0';
  c8:	8d 04 80             	lea    (%eax,%eax,4),%eax
  cb:	83 c1 01             	add    $0x1,%ecx
  ce:	8d 44 42 d0          	lea    -0x30(%edx,%eax,2),%eax
	for (int i = 0; str[i] != '\0'; i++){
  d2:	0f be 51 ff          	movsbl -0x1(%ecx),%edx
  d6:	84 d2                	test   %dl,%dl
  d8:	75 ee                	jne    c8 <myAtoi+0x18>
}
  da:	5d                   	pop    %ebp
  db:	c3                   	ret    
...
000003ea <resetreadcount>:
SYSCALL(resetreadcount)
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 78 08 00 00 	movzbl 0x878(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 6f 08 00 00       	mov    $0x86f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 48 0b 00 00       	mov    %eax,0xb48
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 48 0b 00 00    	mov    0xb48,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 48 0b 00 00    	cmp    %eax,0xb48
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 48 0b 00 00    	mov    0xb48,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 ...
 7c7:	0b 00 00 
 7ca:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 7d1:	0b 00 00 
    base.s.size = 0;
 7d4:	b8 4c 0b 00 00       	mov    $0xb4c,%eax
 7d9:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 7e0:	00 00 00 
